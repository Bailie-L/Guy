...
ACT_NAME = 'auto_skill_1757706267_47'
...
def act(ctx):
    ...
    if not q:
        return 0.0
    boosted = 0
    if 'self_coder' in q and q['self_coder'] > 0.0:
        q['self_coder'] = q['self_coder'] * 1.02
        boosted += 1
    if 'wolf_actions' in q and q['wolf_actions'] > 0.0:
        q['wolf_actions'] = q['wolf_actions'] * 1.02
        boosted += 1
    if 'dream' in q and q['dream'] > 0.0:
        q['dream'] = q['dream'] * 1.02
        boosted += 1
